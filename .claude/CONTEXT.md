...
<!-- What are you actively building right now? What is stable and should not be touched? -->
...
- <!-- Example: "Using Drizzle over Prisma — see docs/adr/001-drizzle.md" -->
...
- <!-- Example: "billing module — handlers done, domain logic 50% complete" -->
...
- <!-- Example: "The `user` table has a legacy `account_id` column — do not remove it" -->
...
- <!-- Example: "Add webhook handler for Stripe events" -->
